...
"""
    plot_spectrum(k_ranges::Tuple, coeffs::Array; title="Power Spectrum", u_idx=1, kwargs...)

Plot the magnitude of the spectral coefficients.
"""
function FFS.plot_spectrum(
    k_ranges::Tuple,
...
"""
function FFS.compare_spectral_analysis(
    input_data,
    results;
    peaks = nothing,
    u_idx = 1,
